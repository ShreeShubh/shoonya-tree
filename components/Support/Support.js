const Support = () => {
  return (
    <div className="h-auto px-5 pt-24 pb-36 bg-[url('/banner07.png')] bg-cover">
      <div className="flex flex-col items-center h-full gap-5 max-w-screen-lg mx-auto">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-xl text-shoonya-black italic">
        ...
        <p className="text-2xl text-[#333536] font-semibold mt-10 text-center">
          Your support makes a difference!
        </p>

        <div className="bg-white p-5 md:p-10 rounded-2xl">
          <p className="text-xl text-[#141414] font-semibold">
            Bank Account Details for Donations:
          </p>
          <div className="flex flex-col gap-2 mt-5">
            <p className="text-xl text-[#141414]">
        ...
        <div className="flex flex-col items-center gap-4 mt-10 text-center">
          <h2 className="text-4xl text-[#486601] italic font-semibold">
